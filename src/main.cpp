...
int myPluginAttach(void) { return PipelinePluginAttach(); }
...
// RpNormMapPluginAttach and RpNormMapAtomicIsInitialized are in <rpnormmap.h>
...
DllMain(HINSTANCE hInst, DWORD reason, LPVOID)
{
	if(reason == DLL_PROCESS_ATTACH){
		...
		// Initialize RW engine instance pointer from game address
